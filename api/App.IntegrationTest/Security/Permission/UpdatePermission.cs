namespace App.IntegrationTest.Security.Permission
{
    ...
    public class UpdatePermission : BaseIntegrationTest
    {
        ...
        private CreatePermissionResponse CreateNewPermission()
        {
            ...
            IResponseData<CreatePermissionResponse> response = this.Connector.Post<CreatePermissionRequest, CreatePermissionResponse>(String.Format(this.BaseUrl, ""), request);
